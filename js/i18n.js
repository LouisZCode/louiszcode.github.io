...
const translations = {
  en: {
    ...
    // New project cards
    "project-agora-title": "Agora Stocks",
    "project-agora-outcome": "LLM council and debate platform for stock financial analysis and narrative evaluation.",
    ...
    "tt-lesson1-title": "Async-First Pays Off",
    "tt-lesson1-desc": "SQLAlchemy 2.0 async sessions with asyncpg eliminate blocking DB calls. Every I/O operation runs concurrently.",
    "tt-lesson2-title": "SSE for Real-Time UX",
    "tt-lesson2-desc": "Streaming translation segment-by-segment gives users immediate feedback instead of waiting for the full result.",
    "tt-lesson3-title": "YAML-Driven Prompts",
    "tt-lesson3-desc": "Separating prompts from code makes prompt iteration fast. Change the YAML, redeploy \u2014 no code changes needed.",
    "tt-technologies": "Technologies",
  ...
  de: {
    ...
    // New project cards
    "project-agora-title": "Agora Stocks",
    "project-agora-outcome": "LLM-Rat und Debattenplattform f\u00fcr Aktienfinanzanalyse und Narrativbewertung.",
    ...
    "tt-lesson1-title": "Async-First zahlt sich aus",
    "tt-lesson1-desc": "SQLAlchemy 2.0 Async-Sessions mit asyncpg eliminieren blockierende DB-Aufrufe. Jede I/O-Operation l\u00e4uft nebenl\u00e4ufig.",
    "tt-lesson2-title": "SSE f\u00fcr Echtzeit-UX",
    "tt-lesson2-desc": "Segment-f\u00fcr-Segment-Streaming gibt Benutzern sofortiges Feedback statt auf das vollst\u00e4ndige Ergebnis zu warten.",
    "tt-lesson3-title": "YAML-gesteuerte Prompts",
    "tt-lesson3-desc": "Prompts vom Code zu trennen macht Prompt-Iteration schnell. YAML \u00e4ndern, neu deployen \u2014 keine Code-\u00c4nderungen n\u00f6tig.",
    "tt-technologies": "Technologien",
  ...
  es: {
    ...
    // New project cards
    "project-agora-title": "Agora Stocks",
    "project-agora-outcome": "Plataforma de consejo y debate LLM para análisis financiero de acciones y evaluación de narrativas.",
    ...
    "tt-lesson1-title": "Async-First vale la pena",
    "tt-lesson1-desc": "Las sesiones async de SQLAlchemy 2.0 con asyncpg eliminan llamadas bloqueantes a la BD. Cada operaci\u00f3n I/O se ejecuta concurrentemente.",
    "tt-lesson2-title": "SSE para UX en Tiempo Real",
    "tt-lesson2-desc": "Transmitir traducci\u00f3n segmento por segmento da feedback inmediato en lugar de esperar el resultado completo.",
    "tt-lesson3-title": "Prompts en YAML",
    "tt-lesson3-desc": "Separar prompts del c\u00f3digo hace la iteraci\u00f3n r\u00e1pida. Cambiar el YAML, redesplegar \u2014 sin cambios de c\u00f3digo necesarios.",
    "tt-technologies": "Tecnolog\u00edas",
